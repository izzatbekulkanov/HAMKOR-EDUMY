...
urlpatterns = [
    ...
    path("bonus/",verified_required(CenterView.as_view(template_name="teacher/bonus.html")), name="teacher-send-bonus" ),
    ...
    path("center-detail/<int:pk>/", CenterDetailView.as_view(template_name="center_detail.html"), name="center-detail" ),
]
