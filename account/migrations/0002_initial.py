...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='kurs',
            field=models.ManyToManyField(blank=True, to='center.kurs', verbose_name='Kurslar'),
        ),
        migrations.AddField(
            model_name='customuser',
        ...
        migrations.AddField(
            model_name='customuser',
            name='role',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.roles', verbose_name='Role'),
        ),
        migrations.AddField(
