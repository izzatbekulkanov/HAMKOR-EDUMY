...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customuser',
            name='sinf',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.sinf', verbose_name='Sinf'),
        ),
        migrations.AddField(
            model_name='customuser',
        ...
        migrations.AddField(
            model_name='cashback',
            name='center',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='center.center', verbose_name="O'quv markazi"),
        ),
        migrations.AddField(
            model_name='customuser',
            name='cashback',
