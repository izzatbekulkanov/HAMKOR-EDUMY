    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_summ', models.BigIntegerField(default=0, verbose_name='Parent uchun summa')),
                ('type', models.CharField(blank=True, choices=[('1', "Ro'yhatdan o'tganlik uchun"), ('2', 'Qabul qilingani'), ('3', "Kurs uchun to'lov"), ('4', 'Referal tizim'), ('5', 'Direktor uchun')], max_length=20, null=True, verbose_name='Turi')),
                ('user_type', models.CharField(choices=[('1', "O'quvchi"), ('2', "O'qituvchi"), ('3', 'Direktor'), ('6', 'SuperAdmin')], max_length=20, verbose_name='Foydalanuvchi turi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('1', "O'quvchi"), ('2', "O'qituvchi"), ('3', 'Direktor'), ('4', 'Administrator'), ('5', 'CEO_Administrator'), ('6', 'SuperAdmin')], default='1', max_length=20, null=True, verbose_name='Type')),
                ...
                ('added_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_users', to=settings.AUTH_USER_MODEL, verbose_name="Qo'shgan foydalanuvchi")),
            ],
            options={
                'verbose_name': 'user',
