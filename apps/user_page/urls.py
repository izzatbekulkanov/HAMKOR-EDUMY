...
from config.decorators import verified_required, AddUserVerified
...
urlpatterns = [
    ...
    path("addAdministrators/",AddUserVerified(UserAppView.as_view(template_name="add_administrator.html")),name="addAdministrators"),
